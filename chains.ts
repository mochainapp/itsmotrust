...
export const appChain = process.env.NEXT_PUBLIC_CHAIN
  ? Number(process.env.NEXT_PUBLIC_CHAIN)
  : 31337;
...
export const CHAINS: {
  ...
  // MO Chain
  7924: {
    urls: ["https://mainnet-rpc.moscan.app/"],
    name: "MO Chain",
    nativeCurrency: {
      name: "MO",
      symbol: "MO",
  ...
  // MO Chain Testnet
  22936: {
    urls: ["https://testnet-rpc.motestnet.app/"],
